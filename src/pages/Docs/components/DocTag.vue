<template>
    <el-dialog v-model="props.dialogVisible" title="上传文档" :show-close="false">
        <div>
...
import { bookData } from '../mock.js';
// const dialogVisible = ref(false)
const props = defineProps(['dialogVisible', 'handleBatchAppendTag']);
const defaultProps = {
    id: 'id',
    label: 'identify',
}
...
const treeData = reactive({
    documents: bookData.data.document_trees
})
...
// const batchAppendTagsHandle = () => {  
//     // 假设treeData是树的原始数据，你需要根据实际情况获取它  
//     selectedKeys.value.forEach(key => {
//         const node = treeRef.value.getNode(key);
