<template>
    <div class="card query flex justify-between flex-1">
    ...
    <div class="card answer item-stretch">
        <div class="flex items-start justify-between">
            <el-icon class="mr-3 mt-1">
                <Monitor />
            </el-icon>
        ...
        <div v-if="!props.export" ref="messageAnchor" class="flex flex-row justify-between self-stretch">
            <div>
                <el-button
...
const emit = defineEmits(['textSelected', 'updateResponseSuccess', 'switchExport', 'deletedMessage']);
